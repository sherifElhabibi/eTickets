...
{
    public class eTicketInitializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                var context = serviceScope.ServiceProvider.GetService<eTicketContext>();
                ...
                {
                    context.Cinema.AddRange(new HashSet<Cinema>()
                    {
                        new Cinema()
                        {
                            Name = "Cinema 1",
                ...
                {
                    context.Actor.AddRange(new HashSet<Actor>()
                    {
                        new Actor()
                        {
                            FullName = "Actor 1",
                ...
                {
                    context.Producer.AddRange(new HashSet<Producer>()
                    {
                        new Producer()
                        {
                            FullName = "Producer 1",
                ...
                {
                    context.Movie.AddRange(new HashSet<Movie>()
                    {
                        new Movie()
                        {
                            Name = "Life",
                ...
                {
                    context.Actors_Movies.AddRange(new HashSet<Actor_Movie>()
                    {
                        new Actor_Movie()
                        {
                            ActorId = 1,
